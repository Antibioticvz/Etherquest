		...
		(this.props.breed.selectBreed) ? (
					<div>
						...
						<Tabs selectedIndex={this.state.tabIndex} onSelect={tabIndex => {
							...
							this.setState({ pair: false })
						}}>
							<TabList>
								<Tab className="buy-button ui black basic button">To public</Tab>
								<Tab className="buy-button ui black basic button">My cards</Tab>
							</TabList>

							<TabPanel>

								{ this.state.pair ? <div className="item-page__wrapper ui container">
									...
									: <div>
										<p className="m--center">Text text text  text text  text text  text text </p>

										<button className="buy-button ui black basic button"
														onClick={()=>this.setState({pair: !this.state.pair})}>OK</button>
									</div>
								}
							...
							<TabPanel>
								...
								<button className="buy-button ui black basic button"> Breed to public</button></center>
							</TabPanel>
